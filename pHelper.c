...
/**
 * str_length - function to returns the length of a string.
...
/**
 * str_duplicate - programe to duplicate  string
...
/**
 * str_compare - function Compare two strings
...
/**
 * str_reverse - it  reverses  string.
 *
 * @string: pointer to string.
 * Return: void.
 */
