#include "shell.h"
/**
 * main - it initializes the variables of the program
...
/**
 * handle_ctrl_c - function to print the prompt in a new line
...
/**
 * inicialize_data - initialize the struct with the info of the program
 ...
 * @prompt: prompt what to be printed
